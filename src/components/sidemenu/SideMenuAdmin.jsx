      ...
      <div className="flex-grow flex flex-col ml-6">
        <nav className="mt-12">
          ...
          >
            ...
            <span className="ml-4 text-sm font-medium">Employees </span>
          </NavLink>
          ...
          >
            ...
            <span className="ml-4 text-sm font-medium">Qualifications </span>
          </NavLink>
          ...
          >
            ...
            <span className="ml-4 text-sm font-medium">Leads</span>
          </NavLink>
